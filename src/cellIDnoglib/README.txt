...
A single subdirectory is also created in the cell_id_1.1 subdirectory:

paw/ --> contains some scripts relevant to running PAW (which program
         can be downloaded from CERN's website (see below).

Sample experimental images and sample PAW-readable database files
can be found at www.molsci.org.
...
BF_position_1_time0.tif
BF_position_1_time1.tif
BF_position_1_time2.tif
BF_position_1_time3.tif

and fluor_in.txt might contain
YFP_position_1_time0.tif
YFP_position_2_time1.tif
YFP_position_3_time2.tif
